...
if( visit.patientFamiltyHistoryStructure != undefined)
{
 ...
 patientFamilyHistoryStructureAsset =  await getAssetRegistry("mtbc.med.net.patientFamiltyHistoryStructure.PatientFamiltyHistoryStructure").then(async function (patientFamilyHistoryStructureAsset){
  ...
  var checkpatientFamilyHistoryStructure = await patientFamilyHistoryStructureAsset.exists(visit.patientFamiltyHistoryStructure.patientFamiltyHistoryStructureId);
  ...
  if(checkpatientFamilyHistoryStructure ){
   return patientFamilyHistoryStructureAsset.update(visit.patientFamiltyHistoryStructure);
  }
  else{
  
    return patientFamilyHistoryStructureAsset.add(visit.patientFamiltyHistoryStructure);
  }
